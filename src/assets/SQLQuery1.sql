...
declare @MensErro VarChar(500)
 ...
 exec Sp_TabParamProc @Procedure = 'Sp_PessoaTelefoneGrava'

 Select * From Dic.Vw_Campo Where Tabela = 'pessoa'


 SELECT MAX(IdPessoa) as IdPessoa from cliente

 select * from pessoa where IdPessoa = 29432
